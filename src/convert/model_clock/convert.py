...
def create_instance_from_scenario(path_to_folder=None, scenario_file=None, location_file=None, output_file=None, domain_file=None, coupling_mode="implicit_free_uncoupling", subproblem="combined"):
   ...
   # If location not specified use default
    ...
    elapsed_time = problem.add_fluent(up.Fluent("elapsed_time", up.IntType()), default_initial_value=up.Int(0))
    ...
    move_aside_empty.add_increase_effect(elapsed_time(), 300)
    ...
    move_aside_occupied.add_increase_effect(elapsed_time(), 300)
    ...
    move_bside_empty.add_increase_effect(elapsed_time(), 300)
    ...
    move_bside_occupied.add_increase_effect(elapsed_time(), 300)
    ...
    wait.add_increase_effect(total_cost(), 300)
    wait.add_increase_effect(elapsed_time(), 300)
    ...
    arrive.add_precondition(elapsed_time() >= arrival(arrive.t))
    ...
    if explicit_uncoupling:
        ...
        uncouple.add_increase_effect(elapsed_time(), 120)
    ...
    if explicit_coupling:
        ...
        couple_two_units.add_increase_effect(elapsed_time(), 180)
        ...
        couple_two_units_same_train.add_increase_effect(elapsed_time(), 180)
