(define (domain scenario_solver_example3_guided-domain)
 ...
 (:predicates 
             ...
             (direction_train ?train - arrivaltrain)
             ...
             (coupling_track_for_request ?request - departurerequest ?trackpart - trackpart)
 ...
 (:action start_move
  ...
  :precondition (and (not (allowed_to_move ?t)) (not (locked_train ?t)) (not (departed ?t)) (not (parked ?t)) (< (concurrent_movements) 1))
 ...
 (:action move_aside_empty
  ...
  :precondition (and (allowed_to_move ?t) (not (locked_train ?t)) (at ?t ?l_from) (connected_aside ?l_from ?l_to) (<= (aside_distance ?t) (astack_distance ?l_from)) (= (number_of_trains_on_track ?l_to) 0) (<= (train_length ?t) (track_length ?l_to)))
 ...
 (:action move_aside_occupied
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (not (locked_train ?t)) (at ?t ?l_from) (connected_aside ?l_from ?l_to) (<= (aside_distance ?t) (astack_distance ?l_from)) (< 0 (number_of_trains_on_track ?l_to)) (<= (train_length ?t) (- (track_length ?l_to) (bstack_distance ?l_to))))
 ...
 (:action move_bside_empty
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (not (locked_train ?t)) (at ?t ?l_from) (connected_bside ?l_from ?l_to) (<= (- (bstack_distance ?l_from) (train_length ?t)) (aside_distance ?t)) (= (number_of_trains_on_track ?l_to) 0) (<= (train_length ?t) (track_length ?l_to)))
 ...
 (:action move_bside_occupied
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (not (locked_train ?t)) (at ?t ?l_from) (connected_bside ?l_from ?l_to) (<= (- (bstack_distance ?l_from) (train_length ?t)) (aside_distance ?t)) (< 0 (number_of_trains_on_track ?l_to)) (<= (train_length ?t) (astack_distance ?l_to)))
 ...
 (:action depart_aside
  :parameters ( ?t - arrivaltrain ?l - trackpart)
  :precondition (and (not (locked_train ?t)) (allowed_to_move ?t) (at ?t ?l) (departure_exit_a ?l) (<= (aside_distance ?t) (astack_distance ?l)))
 ...
 (:action depart_bside
  :parameters ( ?t - arrivaltrain ?l - trackpart)
  :precondition (and (not (locked_train ?t)) (allowed_to_move ?t) (at ?t ?l) (departure_exit_b ?l) (<= (- (bstack_distance ?l) (train_length ?t)) (aside_distance ?t)))
 ...
 (:action park
  :parameters ( ?t - arrivaltrain ?l - trackpart)
  :precondition (and (not (locked_train ?t)) (allowed_to_move ?t) (at ?t ?l) (parking_allowed ?l))
  :effect (and (parked ?t) (assign (number_of_parked_trains ?l) (+ 1 (number_of_parked_trains ?l))) (not (allowed_to_move ?t)) (assign (concurrent_movements) (- (concurrent_movements) 1))))
 (:action uncouple
 ...
 (:action couple_two_units_same_train
  ...
  :precondition (and (matched ?unit_a ?slot_a) (matched ?unit_b ?slot_b) (slot_for_request ?slot_a ?request) (slot_for_request ?slot_b ?request) (slot_before ?slot_a ?slot_b) (not (= ?unit_a ?unit_b)) (unit_in_train ?unit_a ?train) (unit_in_train ?unit_b ?train) (at ?train ?track) (coupling_allowed ?track) (coupling_track_for_request ?request ?track) (unit_before ?unit_a ?unit_b))
  :effect (and (slot_coupled ?slot_a) (slot_coupled ?slot_b) (coupled_to_request ?unit_a ?request) (coupled_to_request ?unit_b ?request) (physically_coupled ?unit_a ?unit_b) (request_assembled ?request)))
