(define (domain scenario_solver_example1-domain)
 ...
 (:action start_move
  ...
  :precondition (and (not (allowed_to_move ?t)) (not (departed ?t)) (not (parked ?t)) (< (concurrent_movements) 1))
 ...
 (:action move_aside_empty
  ...
  :precondition (and (allowed_to_move ?t) (at ?t ?l_from) (connected_aside ?l_from ?l_to) (<= (aside_distance ?t) (astack_distance ?l_from)) (= (number_of_trains_on_track ?l_to) 0) (<= (train_length ?t) (track_length ?l_to)))
 ...
 (:action move_aside_occupied
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (at ?t ?l_from) (connected_aside ?l_from ?l_to) (<= (aside_distance ?t) (astack_distance ?l_from)) (< 0 (number_of_trains_on_track ?l_to)) (<= (train_length ?t) (- (track_length ?l_to) (bstack_distance ?l_to))))
 ...
 (:action move_bside_empty
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (at ?t ?l_from) (connected_bside ?l_from ?l_to) (<= (- (bstack_distance ?l_from) (train_length ?t)) (aside_distance ?t)) (= (number_of_trains_on_track ?l_to) 0) (<= (train_length ?t) (track_length ?l_to)))
 ...
 (:action move_bside_occupied
  :parameters ( ?t - arrivaltrain ?l_from - trackpart ?l_to - trackpart)
  :precondition (and (allowed_to_move ?t) (at ?t ?l_from) (connected_bside ?l_from ?l_to) (<= (- (bstack_distance ?l_from) (train_length ?t)) (aside_distance ?t)) (< 0 (number_of_trains_on_track ?l_to)) (<= (train_length ?t) (astack_distance ?l_to)))
 ...
 (:action depart_aside
  :parameters ( ?t - arrivaltrain ?l - trackpart)
  :precondition (and (allowed_to_move ?t) (at ?t ?l) (departure_exit_a ?l) (<= (aside_distance ?t) (astack_distance ?l)))
 ...
 (:action depart_bside
  :parameters ( ?t - arrivaltrain ?l - trackpart)
  :precondition (and (allowed_to_move ?t) (at ?t ?l) (departure_exit_b ?l) (<= (- (bstack_distance ?l) (train_length ?t)) (aside_distance ?t)))
